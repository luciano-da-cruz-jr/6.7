...
### ✏️ Projeto: Encurtador de URL (API) (Project: URL Shortener (API)) 📚⏳🤔😉

Repositório contendo um projeto, exemplificando como criar uma API que encurta uma URL recebida por parâmetro. (Repository containing a project, exemplifying how to create an API that shortens a URL received as a parameter.)
